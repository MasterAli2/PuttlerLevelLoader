...
public class VanillaPortalLevelObjectDefinition : LevelObjectDefinition
{
    ...
    public override BaseLevelObject Place(SerialLevelObject serialLevelObject)
    {
        ...
        BaseLevelObject baseLevelObject = obj.AddComponent<VanillaPortalLevelObject>();
        ...
        BaseSelectableObject entry = entryObj.AddComponent<BaseSelectableObject>();
        BaseSelectableObject exit = exitObj.AddComponent<BaseSelectableObject>();
